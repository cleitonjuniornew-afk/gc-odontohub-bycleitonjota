// ==========================================================
// Dados mockados do MVP — usados apenas para demonstração.
...
export const disciplines: Discipline[] = [
  {
    id: "d1",
    slug: "dentistica-periodontia",
    name: "Integrativa Dentística / Periodontia",
    color: "#D4AF37",
...
export const tasks: Task[] = [
  {
    id: "t1",
    title: "Revisar cronograma de Endodontia I",
    done: false,
    priority: "ALTA",
    dueDate: "2026-08-05",
    disciplineId: "d3",
  ...
  {
    id: "t2",
    title: "Montar resumo de Semiologia — Cap. 4",
    done: false,
    priority: "MEDIA",
    dueDate: "2026-08-05",
    disciplineId: "d4",
  ...
  {
    id: "t3",
    title: "Separar materiais da clínica de amanhã",
    done: false,
    priority: "ALTA",
    dueDate: "2026-08-04",
    disciplineId: "d1",
  ...
  {
    id: "t4",
    title: "Responder lista de Oclusão",
    done: true,
    priority: "BAIXA",
    dueDate: "2026-08-03",
    disciplineId: "d5",
  ...
  {
    id: "t5",
    title: "Organizar fotos do último atendimento",
    done: false,
    priority: "BAIXA",
    dueDate: "2026-08-06",
    disciplineId: "d1",
...
export const events: AgendaEvent[] = [
  ...
  },
  {
    ...
    type: "clinica",
    color: "#D4AF37",
    start: "2026-08-05T13:00:00",
  },
  {
    id: "e3",
    title: "Aula de Cirurgia I",
    type: "aula",
    color: "#00BFFF",
  ...
  {
    id: "e4",
    title: "Entrega do relatório de Endodontia",
    type: "evento",
    color: "#22C55E",
    start: "2026-08-07T23:59:00",
  },
];
...
export const libraryItems: LibraryItem[] = [
  {
    id: "l1",
    title: "Slides — Anatomia Dentária",
    type: "SLIDE",
    disciplineId: "d1",
    professor: "Dra. Ana Militão",
    subject: "Anatomia",
  ...
  {
    id: "l2",
    title: "PDF — Protocolo de Biossegurança",
    type: "PDF",
    disciplineId: "d2",
    professor: "Dr. Rafael Souza",
    subject: "Biossegurança",
    date: "2026-04-02",
  },
  {
    id: "l3",
    title: "Vídeo — Técnica de Isolamento Absoluto",
    type: "VIDEO",
    disciplineId: "d3",
    professor: "Dra. Camila Prado",
    subject: "Endodontia",
