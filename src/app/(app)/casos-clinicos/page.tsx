...
* Procedimentos sem checklist não aparecem nesta biblioteca.
  */
  const proceduresWithChecklist =
  procedures.filter(
  (procedure) =>
...
proceduresWithChecklist.filter((procedure) => {
...
return ( <div className="min-w-0 w-full space-y-8">
<PageHeader
